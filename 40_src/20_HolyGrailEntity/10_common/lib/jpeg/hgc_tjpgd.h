...
/----------------------------------------------------------------------------*/
#ifndef __LGFX_HGC_TJPGDEC_H__
#define __LGFX_HGC_TJPGDEC_H__
/*---------------------------------------------------------------------------*/
...
JRESULT hgc_jd_prepare (lgfxJdec*, uint32_t(*)(void*,uint8_t*,uint32_t), void*, uint_fast16_t, void*);
JRESULT hgc_jd_decomp (lgfxJdec*, uint32_t(*)(void*,void*,JRECT*), uint_fast8_t);
